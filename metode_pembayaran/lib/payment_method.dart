...
import 'package:metode_pembayaran/confirmation_splash_page.dart';
import 'package:metode_pembayaran/menunggu.dart';
import 'package:metode_pembayaran/rincian.dart';
import 'package:metode_pembayaran/text_form_component.dart';
...
class _PaymentMethodState extends State<PaymentMethodView> {
  ...
  _onButtonPressed() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => const ConfirmationSplashView()));
  }
